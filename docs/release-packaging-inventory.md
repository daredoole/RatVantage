...
| `packaging/rpm/legion-control.spec` | RPM packaging | RPM buildroot paths | package | RPM-owned | `rpmspec -P`, staged smoke checks | Top-level package installs daemon, UI, helpers, and tray; write flags remain disabled by default. |
