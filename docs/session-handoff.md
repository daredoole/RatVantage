...
- The GTK shell now accepts `--gtk-page` and `--gtk-auto-quit-ms` so scripted smoke capture can open a specific dashboard tab and auto-exit without fragile pointer automation.
