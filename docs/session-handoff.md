...
- Latest local commits:
  - `HEAD` (`Surface state in tray and GTK`; run `git log --oneline -1` for the exact hash)
...
- Tray/status output and GTK Status/Fans pages surface the durable GPU pending and saved fan curve state.
